...
<xsl:key name="EntityTypes" 
         ...
         use="if(string-length(name)=0 and self::absolute) then 'EMPTYVALUEREPLACED' else name"/>                                        <!--CR19229 added absolute -->
...
<xsl:template match="/">
  ...
  <!-- and finally the document is enriched by xpath attributes (see ERmodel2.xpath_enrichment.module.xslt) -->
