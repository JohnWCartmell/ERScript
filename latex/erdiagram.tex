...
% \ergradient{#1 x0} {#2 y0} {#3 x1} {#4 y1} {#5 corner radius} {#6 fill} %was \ergrp
...
% \erbox{#1 x0} {#2 y0} {#3 x1} {#4 y1} {#5 corner radius} {#6 fill}
\newcommand {\erbox}[6]
{ 
\ifthenelse{\equal{#6}{1}}
{\psframe[fillstyle=solid,fillcolor=lightyellow](#1,#2)(#3,#4)}
{\psframe[fillstyle=solid,fillcolor=white](#1,#2)(#3,#4)}
}
