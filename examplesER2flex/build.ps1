...
. $TARGET\flexDiagramming\scripts\er2flex2svg.ps1 topDownAbstractLoopTest..logical.xml -animate -debugswitch
#if ($false) 
#{
. $TARGET\flexDiagramming\scripts\er2flex2svg.ps1 simpleDecomposition..logical.xml -animate -debugswitch
. $TARGET\flexDiagramming\scripts\er2flex2svg.ps1 top_edge.slotNoTest..logical.xml -animate -debugswitch
. $TARGET\flexDiagramming\scripts\er2flex2svg.ps1 bottom_edge.slotNoTest..logical.xml -animate -debugswitch
